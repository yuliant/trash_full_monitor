...
<div class="container-fluid">
    ...
    <div class="card mb-3 col-lg-8">
        <div class="card-body">
            <form action="<?php echo base_url('gudang/barang_ubah/') . $barang->ID_BARANG ?>" method="POST">
                ...
                <div class="form-group">
                    ...
                    <input type="number" class="form-control" id="stok_barang" name="stok_barang" value="<?php echo $barang->STOK_BARANG; ?>" required>
                ...
                <div class="form-group">
                    ...
                    <input type="number" class="form-control" id="harga_beli_barang" name="harga_beli_barang" value="<?php echo $barang->HARGA_BELI_BARANG; ?>" required>
                ...
                <div class="form-group">
                    ...
                    <input type="number" class="form-control" id="harga_jual_barang" name="harga_jual_barang" value="<?php echo $barang->HARGA_JUAL_BARANG; ?>" required>
                    <?php echo form_error('harga_jual_barang', '<small class="text-danger pl-3">', '</small>'); ?>
                </div>

                <div class="text-right">
                    <button class="btn btn-primary mr-1" type="submit">Simpan</button>
                    <a href="<?php echo base_url('gudang/barang') ?>" class="btn btn-danger">Batal</a>
                </div>
