						...
						<div class="row">
							<div class="col-lg">
								...
								<div class="p-5">
									...
									<form method="POST" action="<?= base_url('order/kunjungan/save_aksescepat') ?>">
										...
										<div class="form-group">
											...
											<textarea type="text" class="form-control" name="alamat_toko" rows="8" required></textarea>
										</div>
										...
										<div class="form-group">
											...
											<input type="number" class="form-control" name="telp_toko" required>
										</div>
										
										<center><label><b>Bukti Kunjungan</b></label></center>
                                        <div id="my_camera" style="width:200px; margin-left:-35px;"></div>
						                <center>
